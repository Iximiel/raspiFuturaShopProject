...
int myPCF8591::readFromAnalogChannel0(const int& times){
  return readFromAnalogChannel(0,times);
}
int myPCF8591::readFromAnalogChannel1(const int& times){
  return readFromAnalogChannel(1,times);
}
int myPCF8591::readFromAnalogChannel2(const int& times){
  return readFromAnalogChannel(2,times);
}
int myPCF8591::readFromAnalogChannel3(const int& times){
  return readFromAnalogChannel(3,times);
}

int myPCF8591::readFromAnalogChannel(const int& ch,const int& times){
...
bool myPCF8591::getAnalogOutputEnabled() const { return AnalogOutputEnabled_;}
